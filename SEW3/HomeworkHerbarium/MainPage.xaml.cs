...
namespace HomeworkHerbarium {
    public partial class MainPage : ContentPage {
        ...
        private async void bCreateHerbarium_Clicked(object sender, EventArgs e) {
            if (templatePath != "" && outputFolder != "" && nameOfMetaData != "" && pathToImages != "") {
                ...
                await DisplayAlert("Erfolg!", "Das Herbarium wurde erstellt!", "OK");
            } else {
                await DisplayAlert("Fehler!", "Bitte alle Eingaben tätigen und kontrollieren!", "OK");
            }
        }
    }
}
